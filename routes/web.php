...
Route::middleware('check.admin.role')->get('/admin-panel/dashboard', [AdminController::class , 'index'])->name('dashboard');

Route::middleware('check.admin.role')->prefix('admin-panel/management')->name('admin.')->group(function () {
