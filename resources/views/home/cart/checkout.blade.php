                        ...
                        <form action="{{ route('home.payment') }}" method="POST">
                            ...
                            <div class="your-order-area">
                                ...
                                <div class="your-order-wrap gray-bg-4">
                                    ...
                                    <div class="">
                                        <input name="card_number" id="card_number" class="form-control" placeholder="شماره کارت هنگام ثبت نام*" type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" minlength="16" maxlength="16" required>
                                    </div>
                                    <div class="payment-method">
                                        <div class="pay-top sin-payment">
                                            <input id="payStar" class="input-radio" type="radio" value="payStar"
                                                checked="checked" name="payment_method">
                                            <label for="payStar"> درگاه پرداخت پی استار </label>
                                        </div>
                                    </div>
                                </div>
